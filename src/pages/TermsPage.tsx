  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFFBF5' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        {[
          { title: '1. Acceptance of Terms', body: "By accessing or using Safarnama' website and services, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services." },
          { title: '2. Booking and Payment', body: 'All prices displayed on our website are indicative and subject to confirmation by our team. A booking is only confirmed upon receipt of a deposit and written confirmation from Safarnama. The deposit amount (typically 25% of total cost) is non-refundable unless the booking is cancelled by us.' },
          ...
          { title: '5. Traveller Responsibility', body: 'Travellers are responsible for obtaining valid travel documents, visas (if applicable), and travel insurance. Safarnama shall not be liable for any loss, damage, or inconvenience arising from failure to obtain proper documentation.' },
          { title: '6. Limitation of Liability', body: 'Safarnama acts as an agent for hotels, transport providers, and activity operators. We are not liable for any injury, loss, or damage resulting from the services of third-party providers. Our maximum liability in any event shall not exceed the amount paid for the specific package.' },
          ...
          <div key={idx} className="journal-card p-5">
            ...
            {section.body ? (
              ...
              <p className="leading-relaxed text-sm" style={{ color: '#5C4A3A' }}>
                ...
                <a href="mailto:legal@safarnama.com" className="hover:underline" style={{ color: '#5B7FA6' }}>legal@safarnama.com</a>.
              </p>
            )}
          </div>
        ))}
